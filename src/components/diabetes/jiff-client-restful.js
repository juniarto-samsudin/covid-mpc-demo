...
(function (exports, node) {
    console.log('INSIDE diabetes jiff-client-restful.js')
   ...
   */
    function browserPOST(hostname, body, callback) {
        console.log('INSIDE browserPOST')
  ...
  exports.make_jiff = function (jiff, options) {
    console.log('INSIDE make_jiff')
    console.log('jiff:', jiff)
    jiff.hostname = 'http://localhost:8080/'
